...
const about_slider: DataType[] = [
  {
    ...
    title: `Shaping Tomorrow’s Digital Experiences Today`,
    des: `At FlowHashtagMedia, our mission is to deliver unparalleled digital marketing services that elevate your brand's presence. We are committed to crafting tailored strategies and creative solutions that not only engage but inspire your audience. With a focus on premium service, our expert team ensures every hashtag tells your story, driving growth and making your brand unforgettable in today's digital world.`,
  },
